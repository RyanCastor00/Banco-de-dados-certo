...
CREATE TABLE IF NOT EXISTS `copa_do_mundo`.`jogadores` (
  ...
  `n_gol` INT NOT NULL DEFAULT 0,
  `n_cartao_amarelo` INT NOT NULL DEFAULT 0,
  `n_cartao_vermelho` INT NOT NULL DEFAULT 0,
  `faltas_sofrida` INT NOT NULL DEFAULT 0,
  `faltas_comedita` INT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `copa_do_mundo`.`partidas` (
  ...
  `gols_selecao_a` VARCHAR(200) NOT NULL DEFAULT 0,
  `gols_selecao_b` VARCHAR(200) NOT NULL DEFAULT 0,
...
-- -----------------------------------------------------
-- Table `copa_do_mundo`.`acontecimentos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `copa_do_mundo`.`acontecimentos` ;

CREATE TABLE IF NOT EXISTS `copa_do_mundo`.`acontecimentos` (
  `id_jogador` INT NOT NULL,
  `id_partida` INT NOT NULL,
  `tipo_acontecimento` VARCHAR(200) NOT NULL,
  `descricao` VARCHAR(200) NOT NULL,
  PRIMARY KEY (`id_jogador`, `id_partida`),
  INDEX `fk_jogadores_has_partidas_partidas1_idx` (`id_partida` ASC) VISIBLE,
